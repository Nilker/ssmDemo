package com.springmybatis.demo.Redis.aop;

import java.io.Serializable;
import java.lang.reflect.Method;


import com.springmybatis.demo.Redis.aop.RedisCache;
...
public class GetCacheAOP  {
    ...
    @Pointcut("@annotation(com.springmybatis.demo.Redis.aop.GetCache)")
